...
const cardDesignItems: { value: CardDesignType; label: string }[] = [
	{ value: 'default', label: String(i18n.ts._yoruq.cardDesigns.default) },
	{ value: 'blue_sky', label: String(i18n.ts._yoruq.cardDesigns.blueSky) },
	{ value: 'love', label: String(i18n.ts._yoruq.cardDesigns.love) },
	{ value: 'nocturne', label: String(i18n.ts._yoruq.cardDesigns.nocturne) },
	{ value: 'romantic', label: String(i18n.ts._yoruq.cardDesigns.romantic) },
	{ value: 'sakura', label: String(i18n.ts._yoruq.cardDesigns.sakura) },
	{ value: 'night_sky', label: String(i18n.ts._yoruq.cardDesigns.nightSky) },
	{ value: 'pastel', label: String(i18n.ts._yoruq.cardDesigns.pastel) },
];
...
async function send() {
	...
	try {
		...
		await misskeyApi('yoruq/questions/send', {
...
<template>
<div class="yoruq-question-form">
	<MkInfo v-if="notice" class="notice">{{ notice }}</MkInfo>

	<MkTextarea
		v-model="text"
		:placeholder="i18n.ts._yoruq.questionTextPlaceholder"
		:max="MAX_TEXT_LENGTH"
