...
import { encrypt as encryptE2E, isValidPublicKey, generatePublicKey } from '@/utility/yoruq-crypto.js';
...
async function postAnswer() {
	...
	try {
		...
		console.error('[YoruqAnswerForm] Failed to post answer:', err);
	} finally {
		posting.value = false;
	}
}
