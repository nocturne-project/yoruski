...
import type { YoruqQuestion } from './YoruqQuestionCard.vue';

// 仕様: メッセージカードには質問文のみ表示（回答テキストは含めない）
const props = defineProps<{
	question: YoruqQuestion;
}>();
...
const cardDesigns: CardDesign[] = [
	{ id: 'default', name: i18n.ts._yoruq.cardDesigns.default, backgroundColor: '#ffffff', textColor: '#333333', accentColor: '#86b300' },
	{ id: 'blue_sky', name: i18n.ts._yoruq.cardDesigns.blueSky, backgroundColor: '#e8f4fc', gradientColors: ['#87CEEB', '#e8f4fc'], textColor: '#1a5276', accentColor: '#3498db' },
	{ id: 'love', name: i18n.ts._yoruq.cardDesigns.love, backgroundColor: '#ffe4ec', gradientColors: ['#FF69B4', '#ffe4ec'], textColor: '#8b0a50', accentColor: '#ff1493' },
	{ id: 'nocturne', name: i18n.ts._yoruq.cardDesigns.nocturne, backgroundColor: '#2c2c54', gradientColors: ['#483D8B', '#2c2c54'], textColor: '#f5f5f5', accentColor: '#9b59b6' },
	{ id: 'romantic', name: i18n.ts._yoruq.cardDesigns.romantic, backgroundColor: '#fce4ec', gradientColors: ['#DB7093', '#fce4ec'], textColor: '#880e4f', accentColor: '#e91e63' },
	{ id: 'sakura', name: i18n.ts._yoruq.cardDesigns.sakura, backgroundColor: '#fff5f5', gradientColors: ['#FFB7C5', '#fff5f5'], textColor: '#5d4037', accentColor: '#ff7043' },
	{ id: 'night_sky', name: i18n.ts._yoruq.cardDesigns.nightSky, backgroundColor: '#0a0a2a', gradientColors: ['#191970', '#0a0a2a'], textColor: '#ffffff', accentColor: '#ffd700' },
	{ id: 'pastel', name: i18n.ts._yoruq.cardDesigns.pastel, backgroundColor: '#f0f8ff', gradientColors: ['#B0E0E6', '#f0f8ff'], textColor: '#4a6572', accentColor: '#00acc1' },
];
...
async function downloadCard() {
	try {
		...
		link.download = `yoruq-card-${props.question.id}.png`;
		link.href = dataUrl;
		link.click();
	} catch (err) {
		console.error('[YoruqMessageCard] Failed to download card:', err);
	}
}
...
async function emitGenerated() {
	try {
		...
		console.error('[YoruqMessageCard] Failed to generate card:', err);
	}
}
