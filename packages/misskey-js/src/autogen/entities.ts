...
export type AdminYoruqDiscloseRequest = operations['admin___yoruq___disclose']['requestBody']['content']['application/json'];
export type AdminYoruqDiscloseResponse = operations['admin___yoruq___disclose']['responses']['200']['content']['application/json'];
export type AdminYoruqSettingsResponse = operations['admin___yoruq___settings']['responses']['200']['content']['application/json'];
export type AdminYoruqSettingsUpdateRequest = operations['admin___yoruq___settings___update']['requestBody']['content']['application/json'];
export type AdminYoruqSettingsUpdateResponse = operations['admin___yoruq___settings___update']['responses']['200']['content']['application/json'];
...
export type NightPointsMyResponse = operations['night-points___my']['responses']['200']['content']['application/json'];
export type NightPointsRankingRequest = operations['night-points___ranking']['requestBody']['content']['application/json'];
export type NightPointsRankingResponse = operations['night-points___ranking']['responses']['200']['content']['application/json'];
export type NightStatusResponse = operations['night-status']['responses']['200']['content']['application/json'];
...
export type YoruqAnnounceRequest = operations['yoruq___announce']['requestBody']['content']['application/json'];
export type YoruqAnnounceResponse = operations['yoruq___announce']['responses']['200']['content']['application/json'];
export type YoruqMuteCreateRequest = operations['yoruq___mute___create']['requestBody']['content']['application/json'];
export type YoruqMuteDeleteRequest = operations['yoruq___mute___delete']['requestBody']['content']['application/json'];
export type YoruqMuteListResponse = operations['yoruq___mute___list']['responses']['200']['content']['application/json'];
export type YoruqQuestionsAnswerRequest = operations['yoruq___questions___answer']['requestBody']['content']['application/json'];
export type YoruqQuestionsAnswerResponse = operations['yoruq___questions___answer']['responses']['200']['content']['application/json'];
export type YoruqQuestionsAnsweredRequest = operations['yoruq___questions___answered']['requestBody']['content']['application/json'];
export type YoruqQuestionsAnsweredResponse = operations['yoruq___questions___answered']['responses']['200']['content']['application/json'];
export type YoruqQuestionsDeleteRequest = operations['yoruq___questions___delete']['requestBody']['content']['application/json'];
export type YoruqQuestionsReceivedRequest = operations['yoruq___questions___received']['requestBody']['content']['application/json'];
export type YoruqQuestionsReceivedResponse = operations['yoruq___questions___received']['responses']['200']['content']['application/json'];
export type YoruqQuestionsReportRequest = operations['yoruq___questions___report']['requestBody']['content']['application/json'];
export type YoruqQuestionsReportResponse = operations['yoruq___questions___report']['responses']['200']['content']['application/json'];
export type YoruqQuestionsSendRequest = operations['yoruq___questions___send']['requestBody']['content']['application/json'];
export type YoruqQuestionsSendResponse = operations['yoruq___questions___send']['responses']['200']['content']['application/json'];
export type YoruqQuestionsSentRequest = operations['yoruq___questions___sent']['requestBody']['content']['application/json'];
export type YoruqQuestionsSentResponse = operations['yoruq___questions___sent']['responses']['200']['content']['application/json'];
export type YoruqSettingsGenerateKeyRequest = operations['yoruq___settings___generate-key']['requestBody']['content']['application/json'];
export type YoruqSettingsGenerateKeyResponse = operations['yoruq___settings___generate-key']['responses']['200']['content']['application/json'];
export type YoruqSettingsGetResponse = operations['yoruq___settings___get']['responses']['200']['content']['application/json'];
export type YoruqSettingsShowRequest = operations['yoruq___settings___show']['requestBody']['content']['application/json'];
export type YoruqSettingsShowResponse = operations['yoruq___settings___show']['responses']['200']['content']['application/json'];
export type YoruqSettingsUpdateRequest = operations['yoruq___settings___update']['requestBody']['content']['application/json'];
export type YoruqSettingsUpdateResponse = operations['yoruq___settings___update']['responses']['200']['content']['application/json'];
