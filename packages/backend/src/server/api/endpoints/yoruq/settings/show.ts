...
import type { YoruqUserSettingsRepository, UsersRepository } from '@/models/_.js';
...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			...
			// 設定を取得（存在しなければデフォルト値）
			const setting = await this.yoruqUserSettingsRepository.findOneBy({ userId: targetUser.id });
