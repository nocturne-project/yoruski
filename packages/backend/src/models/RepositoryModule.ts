...
const $nightPointsRepository: Provider = {
	provide: DI.nightPointsRepository,
	useFactory: (db: DataSource) => db.getRepository(MiNightPoint).extend(miRepository as MiRepository<MiNightPoint>),
	inject: [DI.db],
};
...
const $yoruqUserSettingsRepository: Provider = {
	provide: DI.yoruqUserSettingsRepository,
	useFactory: (db: DataSource) => db.getRepository(YoruqUserSetting).extend(miRepository as MiRepository<YoruqUserSetting>),
	inject: [DI.db],
};

const $yoruqQuestionsRepository: Provider = {
	provide: DI.yoruqQuestionsRepository,
	useFactory: (db: DataSource) => db.getRepository(YoruqQuestion).extend(miRepository as MiRepository<YoruqQuestion>),
	inject: [DI.db],
};

const $yoruqMutedUsersRepository: Provider = {
	provide: DI.yoruqMutedUsersRepository,
	useFactory: (db: DataSource) => db.getRepository(YoruqMutedUser).extend(miRepository as MiRepository<YoruqMutedUser>),
	inject: [DI.db],
};

const $yoruqReportedQuestionsRepository: Provider = {
	provide: DI.yoruqReportedQuestionsRepository,
	useFactory: (db: DataSource) => db.getRepository(YoruqReportedQuestion).extend(miRepository as MiRepository<YoruqReportedQuestion>),
	inject: [DI.db],
};
